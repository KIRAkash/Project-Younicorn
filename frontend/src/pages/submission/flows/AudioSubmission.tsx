...
import { ArrowLeft, Mic, Upload, X, Loader2, Rocket, Sparkles, Play, StopCircle, FileText, Lightbulb, CheckCircle, Plus, Users, TrendingUp, IndianRupee, Target } from 'lucide-react'
...
export function AudioSubmission({ onBack }: AudioSubmissionProps) {
  const [currentStep, setCurrentStep] = useState(1) // 1: Audio, 2: Basic Info
  ...
  const nextStep = () => {
    if (!audioFile) {
      toast({
        ...
        description: 'Please record or upload an audio pitch',
        variant: 'destructive',
      })
      return
    }
    ...
    try {
      ...
      const submissionData = {
        ...
        company_info: {
          ...
          company_structure: 'private_limited',
      ...
      toast({
        title: 'Success!',
        description: 'Your audio pitch has been submitted for analysis',
      })
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : 'Failed to submit audio pitch',
        variant: 'destructive',
      })
    } finally {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-8">
      {/* Hero Header */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-pink-500 via-red-500 to-orange-500 p-8 shadow-2xl">
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-4xl font-black text-white">Audio Pitch</h1>
            </div>
          ...
          <p className="text-white/90 text-lg max-w-2xl font-medium">
            {currentStep === 1 
              ? 'Record or upload your audio pitch (max 50MB)'
      ...
      {currentStep === 1 && (
        <div className="space-y-8 animate-in fade-in duration-500">
          ...
          <Card className="border-2 border-blue-200 dark:border-blue-700 shadow-lg bg-blue-50/50 dark:bg-blue-900/20">
            <CardHeader className="bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900 dark:to-cyan-900 border-b-2 border-blue-300">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-2xl font-bold text-blue-900 dark:text-blue-100">What to Include in Your Audio Pitch</CardTitle>
          ...
          <Card className="border-2 border-gray-200 dark:border-gray-700 shadow-lg">
            <CardHeader className="bg-gradient-to-r from-pink-50 to-red-50 dark:from-gray-800 dark:to-gray-700 border-b-4 border-pink-500">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-gradient-to-br from-pink-500 to-red-600 rounded-lg">
                  <Mic className="w-6 h-6 text-white" />
                </div>
                <div>
                  <CardTitle className="text-2xl font-bold">Your Audio Pitch</CardTitle>
                  <CardDescription className="text-base">Record directly or upload an audio file</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-6 pt-6">
              {!audioFile ? (
                <>
                  ...
                  <div className="flex justify-center gap-4">
                    {!isRecording ? (
                      <Button
                        ...
                        size="lg"
                        className="bg-gradient-to-r from-pink-500 to-red-600 hover:from-pink-600 hover:to-red-700 text-white font-bold shadow-lg"
                      >
                  ...
                  {isRecording && (
                    <div className="flex justify-center">
                      <div className="flex items-center gap-3 px-6 py-3 bg-red-50 dark:bg-red-900/20 border-2 border-red-500 rounded-full">
                        <div className="w-3 h-3 bg-red-500 rounded-full animate-pulse"></div>
                        <span className="font-semibold text-red-600 dark:text-red-400">Recording in progress...</span>
                      </div>
                    </div>
                  )}
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      isAudioDragActive ? 'border-pink-500 bg-pink-50 dark:bg-pink-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-pink-400'
                    )}
                  >
                    <input {...getAudioInputProps()} />
                    <Upload className="w-16 h-16 mx-auto mb-4 text-gray-400" />
                    <p className="text-xl font-semibold mb-2">
                      {isAudioDragActive ? 'Drop audio here' : 'Upload Audio File'}
                    </p>
                ...
                <div className="space-y-4">
                  <div className="p-8 bg-gradient-to-br from-pink-50 to-red-50 dark:from-gray-800 dark:to-gray-700 rounded-xl">
                    {audioPreviewUrl && (
                      <div className="space-y-4">
                        <div className="flex justify-center">
          ...
          <div className="flex justify-between gap-4 pt-4">
            ...
            <Button 
              ...
              disabled={!audioFile}
              size="lg"
              className="px-8 bg-gradient-to-r from-pink-500 to-red-600 hover:from-pink-600 hover:to-red-700 text-white font-bold shadow-lg"
            >
            ...
            <CardContent className="space-y-4 pt-6">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <Select onValueChange={(value) => setValue('product_stage', value)}>
                    <SelectTrigger>
                      <SelectValue placeholder="Select stage" />
                    </SelectTrigger>
                    <SelectContent>
